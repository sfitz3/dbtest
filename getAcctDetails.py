...
#Customize the query and name of the outfile
...
i = 0
years = 1
ariaoutfile = 'shipapp12-5-prod.csv'
readfile = 'shipsort.csv'
...
def callAria (e_date1,e_date2):
    with open(ariaoutfile, 'a+') as outfile:
        ...
        ariaGetAcctUrl = ariaObjectURL + '?client_no=' + clientID + '&auth_key=' + auth + '&rest_call=get_account_details&query_string=where created >'+str(e_date1)+' and created <'+str(e_date2)+'&supp_field_name=Product_Family&supp_field_value=ShipperApplication&limit=20000&output_format=json'
...
lmonth = 11
lstartday = 30  #start with 7/11
ldaystoprocess =5 #starting at 5/1 is 578
lyear = 2017
