...
if isProduction:
    ...
    ariaEndPoint= 'XXXhttps://secure.ariasystems.net/api/ws/api_ws_class_dispatcher.php'
    ...
    ariaEndPoint = 'XXXhttps://secure.future.stage.ariasystems.net/api/ws/api_ws_class_dispatcher.php' #core URL
